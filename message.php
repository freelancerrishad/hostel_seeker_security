...
<body>
    ...
    <div class="container">
        <?php
        $getReceiver = "SELECT * FROM hostel WHERE id = '$id'";
        ...
        <div class="card mt-4">
            ...
            ?>
                    <div class="card-body">
                        ...
                        $sql1 = "SELECT * FROM messages WHERE sent_by = '$username' AND received_by = '$id' OR sent_by = '$username' AND received_by = '$id' ORDER BY createdAt asc";
